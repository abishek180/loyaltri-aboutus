...
export default function Home() {
  ...
  <div className="flex flex-col justify-center items-center gap-10">
    <Link href="/about" className="text-white text-5xl md:text-[80px] text-center font-semibold w-full lg:w-[950px]">HRMS Platform Designed by HR for HR</Link>
    <p className="text-[16px] font-normal text-center w-full md:w-[650px]">A simple and efficient way for HR to manage your People. A ton of automation, simple pricing, fast support.</p>
    </div>
  </div>
  </section>    
  <section className="">
      ...
      <div className=" h-[400vh] [view-timeline-name:--reveal-wrapper]">
        <div className="sticky top-0 flex min-h-screen items-center justify-center">
          <div className="w-full lg:w-[700px]">
            ...
            We started with WFM to tackle the education sector's HR issues. After success, we expanded to health and retail. By interviewing over 100 HR professionals, we created our new HRMS software, Loyaltri.
            </p>
          </div>
        </div>
      </div>
