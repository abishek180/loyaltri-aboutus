...
const Footer = () => {
  return (
    <div>
      <div className="flex flex-col justify-center items-center gap-5 bg-white h-auto lg:h-[465px] w-[calc(100%_-_10%)] mx-auto relative bottom-[130px] rounded-[16px] z-30  p-8 lg:p-12">
        <div className="flex flex-col justify-center items-center gap-8">
            ...
            <p className="w-full lg:[1000px] text-[#667085] text-xl md:text-2xl font-medium text-center">
